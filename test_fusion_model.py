...
from additional_moduel.common import YCrCb2RGB, clamp
...
if __name__ == '__main__':
    ...
    parser.add_argument('--fusion_pretrained', default='D:\code of lunwen\PIAFusion\pretrained\model_epoch_28.pth',
