...
from models.resnet_cls_models import Illumination_classifier
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_path', metavar='DIR', default='illiminate--datasets/cls_dataset',
    ...
    if args.arch == 'cls_model':
        ...
        for epoch in range(args.start_epoch, args.epochs):
            ...
            # 保存最佳模型权重
            if best_prec1 < prec1:
                torch.save(model.state_dict(), f'{args.save_path}/best_cls_res_softmax.pth')
                best_prec1 = prec1
